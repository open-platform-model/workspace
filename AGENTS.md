...
| `opmodel.dev/` | Public Hugo docs site plus Go `docgen` that generates schema (from `core`) and CLI (from `cli`) reference. | `AGENTS.md`, `CONSTITUTION.md` | `task generate`, `task serve`, `task build`, `task check` |
