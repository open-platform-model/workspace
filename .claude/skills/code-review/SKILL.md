...
|----------|------|----------|-----------------|
| Critical | Red | Security vulnerabilities, crashes, data loss, corruption | Must fix before merge |
| Major | Orange | Bugs, performance issues, missing error handling | Should fix |
| Minor | Yellow | Code smells, maintainability issues, test gaps | Nice to fix |
| Nitpick | Green | Style preferences, naming suggestions, documentation | Optional |
